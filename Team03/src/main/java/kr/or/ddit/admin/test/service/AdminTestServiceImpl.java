...
import kr.or.ddit.admin.test.dao.AdminTestMapper;
...
public class AdminTestServiceImpl implements AdminTestService, BaseService {

	@Inject
	AdminTestMapper testMapper;
	...
	@Value("#{dirInfo.saveDirAdminTest}")
	...
	@Override
	public List<TestVO> readTestList(PaginationInfo paging, String testCd) {
		if(paging!=null) {
			int totalRecord = testMapper.selectTotalTest(paging, testCd);
			paging.setTotalRecord(totalRecord);
		}
		
		List<TestVO> testList = testMapper.selectTestList(paging, testCd);
	...
	@Override
	public int readTotalTest(PaginationInfo paging, String testCd) {
		return testMapper.selectTotalTest(paging, testCd);
	}
	...
	@Override
	public ServiceResult removeAdminTestList(List<Integer> testNo) {
		ServiceResult result = null;
		if(testMapper.deleteAdminTestList(testNo) > 0 ) {
			result = ServiceResult.OK;
		} else {
			result = ServiceResult.FAIL;
		}
