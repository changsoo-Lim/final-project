...
<!DOCTYPE html>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/admin/company/companyDetail.css">
	...
	<ul class="nav nav-tabs" id="filterTabs" role="tablist">
		<li class="nav-item" role="presentation">
			<button class="nav-link active" id="company-detail-tab"
				...
				type="button" role="tab" aria-controls="comYpany-detail-type"
	...
	<div class="tab-content" id="filterTabsContent">
			...
			<div class="section">
				...
				<form action="">
					...
					<div class="row mb-3">
						...
						<div class="col-md-4">
							<input type="text" class="form-control bg-light"
								value="${company.compJob }" readonly>
						</div>
						<label class="col-md-2 col-form-label">직무상세</label>
						<div class="col-md-4">
							<input type="text" class="form-control bg-light"
								value="${company.compJobDetail }" readonly>
						</div>
					</div>
		...
		<div class="tab-pane fade" id="content" role="tabpanel"
			...
			<div class="section">
				...
				<!-- 버튼 -->
				<button id="saveIntroBtn" class="btn btn-primary btn-sm">저장</button>
			</div>
									...
									<div class="card review-card h-100"
										...
										<div class="card-body">
											...
											<h6 class="card-subtitle mb-2 text-muted">평점:
												${item.reviewRating} / 5</h6>
											<p class="card-text">${item.reviewCont}</p>
											<p class="card-text">
...
<script
	src="${pageContext.request.contextPath}/resources/js/admin/company/admCompanyDetail.js"></script>
