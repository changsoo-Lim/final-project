...
<link rel="stylesheet" href="<c:url value="/resources/css/admin/test/testEdit.css" />">
<%-- <pre>${testQuestnList }</pre> --%>
<form action="<c:url value="/admin/test/${test.testNo}" />" id="testForm" enctype="multipart/form-data" method="POST" >
	                ...
	                <h2 class="mb-4">검사 수정</h2>
		                ...
		                <div class="mb-3 d-flex justify-content-between">
		                    ...
		                    <div class="d-flex">
		                        ...
		                        <button type="button" id="resetForm" class="btn btn-secondary me-2" onclick="location.href='<c:url value="/admin/test/list" />'">취소</button>
...
<script src='<c:url value="/resources/js/admin/test/testEdit.js" />'></script>
