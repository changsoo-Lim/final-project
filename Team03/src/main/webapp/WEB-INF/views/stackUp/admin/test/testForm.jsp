...
<link rel="stylesheet" href="<c:url value="/resources/css/admin/test/testForm.css" />">

<form action="<c:url value="/admin/test/insert" />" id="testForm" enctype="multipart/form-data" method="post" >
	                ...
	                <h2 class="mb-4">검사 등록</h2>
		                ...
		                <div class="mb-3 d-flex justify-content-between">
		                    ...
		                    <div class="d-flex">
		                        ...
		                        <button type="button" id="resetForm" class="btn btn-secondary" onclick="location.href='<c:url value="/admin/test/list" />'">취소</button>
		                    </div>
		                </div>
...
<script src='<c:url value="/resources/js/admin/test/testForm.js" />'></script>
