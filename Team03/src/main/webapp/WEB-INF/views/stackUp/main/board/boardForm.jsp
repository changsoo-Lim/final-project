...
<div class="board-detail-container">
    <form:form  method="post" enctype="multipart/form-data" modelAttribute="board">
        ...
        <div class="title-container">
            ...
            <form:input type="text" path="boardTitle" class="form-control" id="boardTitle" required="required" />
        ...
        <button type="button" id="autoFillBtn" class="btn btn-info">데이터 입력</button>
            ...
            <a href="<c:url value='/main/board'/>" class="btn btn-primary " style="float: right;">목록</a>
        </div>
    </form:form>
</div>
</div>
